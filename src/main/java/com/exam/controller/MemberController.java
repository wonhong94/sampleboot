...
public class MemberController {
	...
	public String mypage() {
		...
		// AuthenticationUsernamePasswordAuthenticationToken [Principal=Member [userid=홍길동, passwd=1234, username=홍기원], Credentials=[PROTECTED]
		
		
		//AuthProvider에 저장된 Authentication 을 얻자
